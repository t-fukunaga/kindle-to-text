...
class Main:
    ...
    page_number, file_name, img_file_path = capture.window_capture(direction, x_1, y_1, x_2, y_2)

    # 取得した画像から文字を抽出してひとつのtxtファイルに保存
    file_name_txt, txt_file_path = ocr.extract_characters(page_number, file_name, img_file_path, language)
    print(file_name)
    print(file_name_txt)
